...
ActiveRecord::Schema[7.0].define(version: 20_221_115_140_021) do
  ...
  create_table 'categories_payments', id: false, force: :cascade do |t|
    ...
    t.index %w[category_id payment_id], name: 'index_categories_payments_on_category_id_and_payment_id'
  end
